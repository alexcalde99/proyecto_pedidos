                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="heading-content">
                                <h2 style="color: orange">Sobre nosotros</h2>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="authors">
                            <div class="col-md-3 col-sm-6">
                                <div class="team-thumb">
                                    <div class="author">
                                        <img src="<?php echo base_url(); ?>assets/images/author1.jpg" alt="Tracy - templatemo">
                                    </div>
                                    <div class="overlay">
                            ...
                            <div class="col-md-3 col-sm-6">
                                <div class="team-thumb">
                                    <div class="author">
                                        <img src="<?php echo base_url(); ?>assets/images/author2.jpg" alt="Mary - templatemo">
                                    </div>
                                    <div class="overlay">
                                        <!--<div class="author-caption">
                                            <ul>
                                                <li>Alejandro Calderón Girón</li>
                                                <li><a href="#"><i class="fa fa-twitter"></i></a></li>
                                                <li><a href="#"><i class="fa fa-linkedin"></i></a></li>
                                            </ul>
                                         </div>-->
                            ...
                            <div class="col-md-3 col-sm-6">
                                <div class="team-thumb">
                                    <div class="author">
                                        <img src="<?php echo base_url(); ?>assets/images/author3.jpg" alt="Julia - templatemo">
                                    </div>
                                    <div class="overlay">
                                        <!--<div class="author-caption">
                                            <ul>
                                 ...
                                 <div class="author-details">
                                     <h2>Julia</h2>
                                     <span>Dep. Marketing</span>
                                 </div>
                            </div>
                            <div class="col-md-3 col-sm-6">
                                <div class="team-thumb">
                                    <div class="author">
                                        <img src="<?php echo base_url(); ?>assets/images/author4.jpg" alt="Linda - templatemo">
                                    </div>
                                    <div class="overlay">
